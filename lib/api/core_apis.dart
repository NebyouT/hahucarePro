...
class CoreServiceApis {
  ...
  static Future<RxList<BodyChartTemplate>> getBodyChartTemplates({
    required List<BodyChartTemplate> templateList,
  }) async {
    final res = BodyChartTemplateRes.fromJson(await handleResponse(await buildHttpResponse(APIEndPoints.getBodyChartTemplates)));
