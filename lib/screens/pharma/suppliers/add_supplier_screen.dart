                    ...
                    () => AppTextField(
                      ...
                      onTap: () {
                        serviceCommonBottomSheet(
                          ...
                          child: Obx(
                            () => BottomSelectionSheet(
                              title: locale.value.selectPharma,
                              hintText: locale.value.searchForPharma,
                              hasError: addSupplierCont.hasErrorFetchingPharma.value,
                              isEmpty: !addSupplierCont.isPharmaLoading.value && addSupplierCont.pharmaList.isEmpty,
                              errorText: addSupplierCont.errorMessagePharma.value,
                              isLoading: addSupplierCont.isPharmaLoading,
                              searchApiCall: (searchText) {
                                // Implement search if needed, for now just filter locally
                              },
                              onRetry: () {
                                addSupplierCont.fetchPharmaList();
                              },
                              listWidget: Obx(
                                () => ListView.separated(
                                  itemCount: addSupplierCont.pharmaList.length,
                                  shrinkWrap: true,
                                  itemBuilder: (context, index) {
                                    final pharma = addSupplierCont.pharmaList[index];
                                    return SettingItemWidget(
                                      title: pharma.fullName.validate(),
