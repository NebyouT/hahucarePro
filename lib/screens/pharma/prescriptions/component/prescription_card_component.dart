                    ...
                    children: [
                      AppButton(
                        ...
                        onTap: () {
                          ...
                          PharmaApis.changePrescriptionStatus(request: request).then((value) async {
                            toast(value.message);
                            await Get.find<HomeController>().getDashboardDetail();
                            await Get.find<AllPrescriptionsController>().getPrescriptions();
                          });
                        },
