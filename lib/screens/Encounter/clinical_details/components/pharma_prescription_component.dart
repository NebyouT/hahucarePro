            ...
            onTap: () {
              ...
              Get.bottomSheet(
                ...
                if (result is Pharma && result.id > 0) {
                  if (clincalDetailCont.selectedPharma.value.id != -1 && clincalDetailCont.selectedPharma.value.id != result.id) {
                  ...
                  Get.to(
                      ...
                      arguments: {
                        ...
                        'medsAlreadyInPresc': clincalDetailCont.prescriptionList.map((e) => e.medicine.id).toList(),
                      }
                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ).visible(clincalDetailCont.prescriptionList[index].instruction.isNotEmpty),
                          ],
                        ),
                      );
                    },
