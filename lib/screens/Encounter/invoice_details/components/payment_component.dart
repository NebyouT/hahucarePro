        ...
        children: [
          ...
          Column(
            children: [
              ...
              Row(
                children: [
                  Text(locale.value.subtotal, style: secondaryTextStyle()).expand(),
                  PriceWidget(
                ...
                children: [
                  Row(
                    children: [
                      ...
                      else if (paymentData.billingFinalDiscountType == TaxType.FIXED)
                        PriceWidget(
              ...
              ).paddingTop(8).visible(paymentData.billingFinalDiscountValue > 0),
              ...
              if (paymentData.isExclusiveTaxesAvailable)
                detailWidgetPrice(
                  leadingWidget: Row(
                    ...
                    children: [
                      Text(
                        paymentData.exclusiveTaxList.length == 1 ? paymentData.exclusiveTaxList.first.title : locale.value.exclusiveTax,
